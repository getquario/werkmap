...
const worksheet = (name, styles, sst, knows) => {
  ...
  return {
    ...
    filter(range) {
      ...
      // rather than reasoned about, in both readers: Excel opens a file
      // carrying only this element with no repair prompt and reports the
      // sheet's autofilter as on, and LibreOffice keeps the filter and writes
      // that name itself on save. The name is a reader's bookkeeping.
      filtered =
        range === null
          ? ""
